...
<head>
    ...
    <link rel="stylesheet" href="CSS/adresboekStyleAdminContacten.css">
    ...
    <div id="mainSearchBlock" class="inline-blocks">
        <!-- Linker Menu -->
            ...
            <div id="mainListItemsLinksBlock3">
                <button type="button" >
                    <a href="FunctiePaginas/add_Contact.php">
        ...
        <div id="pagination" class="container-inline-blocks">
                ...
                <div id="paginationInhoud" class="inline-blocks">
                    <div  id="afmetingenPijlLinks" class="inline-blocks">
                        ...
                        if($pagination->has_previous_page()){
                            if(isset($_GET['order']) && isset($_GET['sort'])){
                                echo "<a href=adresboekAdminContacten.php?page={$pagination->previous_page()}&order={$_GET['order']}&sort={$_GET['sort']}>" ;
                                echo '<i class="fas fa-arrow-left"></i>';
                                echo '</a>';
                            }else{
                                echo "<a href=adresboekAdminContacten.php?page={$pagination->previous_page()}>" ;
                                echo '<i class="fas fa-arrow-left"></i>';
                                echo '</a>';
                            }
                        }else{
                    ...
                    <div id="afmetingenHuidigePagina" class="inline-blocks">
                        ...
                        if($page == $pagination->total_pages()){
                            if(isset($_GET['sort']) && isset($_GET['order']))
                            {
                                ...
                                echo "<a href='adresboekAdminContacten.php?page=1'>1</a>";
                            }
                        }
                        else{
                    ...
                    <div id="afmetingenTotalePagina" class="inline-blocks ">
                        ...
                        <?php
                        //pijl terug
                        echo "<a href=\"adresboekAdminContacten.php?page={$pagination->total_pages()}\">{$pagination->total_pages()}</a> ";
                        ?>
                    ...
                    <div id="afmetingenPijlRechts" class="inline-blocks ">
                        ...
                        if($pagination->has_next_page()){
                            if(isset($_GET['order']) && isset($_GET['sort'])){
                                echo "<a href=adresboekAdminContacten.php?page={$pagination->next_page()}&order={$_GET['order']}&sort={$_GET['sort']}>" ;
                                echo '<i class="fas fa-arrow-right"></i>';
                                echo '</a>';
                            }else{
                                echo "<a href=adresboekAdminContacten.php?page={$pagination->next_page()}>" ;
                                echo '<i class="fas fa-arrow-right"></i>';
                                echo '</a>';
                            }
                        }else{
            ...
            <div id="mainSideBarBlockPositie" class="inline-blocks">
                ...
                <div id="mainSideBarBlockSorteer" class="inline-blocks">
                    <div>
                        <h1>Sorteren op:</h1>
                        <button type="button">
                            <a href="adresboekAdminContacten.php?page=<?php echo $page ?>&order=<?php echo contactSortArray()[0]?>&sort=<?php echo $sort?>">
                                Naam
                            </a>
                        </button>
                        <button type="button">
                            <a href="adresboekAdminContacten.php?page=<?php echo $page ?>&order=<?php echo contactSortArray()[1]?>&sort=<?php echo $sort ?>">
                                Standplaats
                            </a>
                        </button>
                        <button type="button">
                            <a href="adresboekAdminContacten.php?page=<?php echo $page ?>&order=<?php echo contactSortArray()[2]?>&sort=<?php echo $sort ?>">
                                Bedrijfsnaam
                            </a>
                        </button>
                    </div>
                ...
                <div id="mainSideBarBlockToevoegenEnUitloggen" class="inline-blocks">
                    ...
                    <div class="container-inline-blocks" >
                        <a href="FunctiePaginas/add_Contact.php"><i class="fas fa-plus-square"></i></a>
                    </div>
                    <!-- log uit functie -->
                    <div class="container-inline-blocks">
